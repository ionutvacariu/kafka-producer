...
public class Payment2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7257673298231727002L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment2\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}");
   ...
   */
  public static BinaryMessageEncoder<Payment2> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public Payment2(java.lang.CharSequence id, java.lang.Double amount) {
    this.id = id;
    this.amount = amount;
  }
   ...
   */
  public static Payment2.Builder newBuilder() {
    return new Payment2.Builder();
  }
   ...
   * @return A new Payment2 RecordBuilder
   */
  public static Payment2.Builder newBuilder(Payment2.Builder other) {
    if (other == null) {
      return new Payment2.Builder();
    } else {
      return new Payment2.Builder(other);
    }
  }
   ...
   * @return A new Payment2 RecordBuilder
   */
  public static Payment2.Builder newBuilder(Payment2 other) {
    if (other == null) {
      return new Payment2.Builder();
    } else {
      return new Payment2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Payment2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Payment2 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public Payment2.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Payment2.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Payment2.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Payment2.Builder clearAmount() {
